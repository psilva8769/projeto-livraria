    ...
    <section className='max-padd-container py-12 xl:py-24'>
      ...
      <div className='flexCenter flex-col gap-16 xl:gap-8 xl:flex-row'>
        ...
        <div className='flex-1'>
          <Title title1={"Descubra as "} title2={"principais vantagens da nossa loja!"} titleStyles={'pb-10'} paraStyles={'!block'}/>
          <div className='flex flex-col items-start gap-y-4'>
            <div className='flexCenter gap-x-4'>
              ...
              <div>
                <h4 className='medium-18'>Processo de Devolução Fácil</h4>
            ...
            <div className='flexCenter gap-x-4'>
              ...
              <div>
                <h4 className='medium-18'>Opções de Pagamento Seguras</h4>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo facere fugiat officiis veritatis.</p>
              </div>
            </div>
            <div className='flexCenter gap-x-4'>
              ...
              <div>
                <h4 className='medium-18'>Atendimento ao Cliente em Tempo Real</h4>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quo facere fugiat officiis veritatis.</p>
              </div>
            </div>
          </div>
